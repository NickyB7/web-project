...
<div id="bar5">
  ...
  <a href="dashboard.php">Exam card</a>
	</div><br>
<div class="vertical-menu" id="bar4">
  <a href="dashboard.php">Pass List</a>
	</div>
	<div class="vertical-menu" id="bar3">
  <a href="dashboard.php">Approved Course Transer</a>
	</div>
	<div class="vertical-menu" id="bar4">
  <a href="dashboard.php">Confirmation of Names for Graduating Students</a>
	</div>
	<div class="vertical-menu" id="bar3">
  <a href="dashboard.php">Graduands Invitation Cards</a>
	</div>
	<div class="vertical-menu" id="bar4">
  <a href="dashboard.php">Provisional Results</a>
	</div></fieldset>
</div>
