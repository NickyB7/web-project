...
<form class="pure-form" action="student.php" method="post" >
    <fieldset style="border-radius: 20px;">
        <legend>Login to Students Portal</legend>
	   <input type="email" id="text" name="email" placeholder="Email"><br><br>
        <input type="password" name="password" placeholder="Password" id="password" required><br><br>
        <input type="reset" value="Reset Login Form" style="background-color: #42b72a;color: white; font-size: 16px; width: 150px;
	  text-align: center;
		padding: 7px;
		border-radius: 4px;
		margin-right: 16px;" /><br><br><br><br>
        <button type="submit" name="submit" class="pure-button pure-button-primary" id="button">Login</button>
