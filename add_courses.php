...
<form class="pure-form" action="addcourses.php" method="post">
    <fieldset style="border-radius: 20px;">
        <legend>Add Students Kenya Institute</legend>
        <br><br><br>
        <input type="text" id="text" name="course" placeholder="add course" required="course"><br><br>
	...
	<script type="text/javascript">
		...
		var password = document.getElementById("course");
