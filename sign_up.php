...
<form class="pure-form" action="sign.php" method="post">
    <fieldset style="border-radius: 20px;">
        <legend>Signup to Kenya Institute</legend>
	  ...
	  text-align: center;
        ...
        <button type="submit" class="pure-button pure-button-primary" id="button">Signup</button>
    </fieldset>
</form>	
