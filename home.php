...
<body style="font-family: tahoma;background-color: #e9ebee;">
  ...
  <div style="background:white;border:rgb(59, 89, 152) 3px SOLID;
      ...
      <marquee direction="right" behavior="alternate"  >  
          ...
          <div id="bar2" style="float: left; width: 400px; "> 
          ...
          <marquee direction="right" behavior="alternate">  
           ...
           <div id="bar2" style="float: right; width: 400px; "> 
           ...
           <div  id="bar2" style="float: center; width: 500px; text-align: left;padding-top: 50px;">
               ...
               <img src="ll.jpg" width="250" height="200"><br><br><br><br>
